...
export { default as Logs } from '../../components/dashboard/Logs.vue'
export { default as Progress } from '../../components/dashboard/Progress.vue'
export { default as Quote } from '../../components/dashboard/Quote.vue'
...
export const LazyLogs = import('../../components/dashboard/Logs.vue' /* webpackChunkName: "components/dashboard/Logs" */).then(c => c.default || c)
export const LazyProgress = import('../../components/dashboard/Progress.vue' /* webpackChunkName: "components/dashboard/Progress" */).then(c => c.default || c)
export const LazyQuote = import('../../components/dashboard/Quote.vue' /* webpackChunkName: "components/dashboard/Quote" */).then(c => c.default || c)
