    ...
    <header class="h-screen flex flex-col items-center">
      <div class="h-1/2 flex flex-col items-center justify-end">
        ...
        <div class="my-4 grid grid-cols-2 gap-4">
          <nuxt-link
            to="/get-started"
            class="border-1 border-teal-500 bg-teal-500 rounded px-4 py-2 text-white text-center uppercase hover:bg-teal-400 hover:border-teal-400 transition duration-300 linear"
          >
            I'm Ready
          </nuxt-link>
          <button
            class="border border-teal-500 bg-white rounded px-4 py-2 text-teal-500 text-center uppercase hover:bg-teal-400 hover:border-teal-400 hover:text-white transition duration-300 linear"
          >
            Learn More
          </button>
        </div>
